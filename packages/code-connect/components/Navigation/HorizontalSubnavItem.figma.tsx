...
figma.connect(
  NavItem,
  'https://www.figma.com/design/aEBBvq0J3EPXxHvv6WgDx9/PatternFly-6--Components-Test?node-id=2104-7269&m=dev',
  {
    props: {
    ...
    example: (props) => <NavItem isActive={props.isActive}>{props.navItem}</NavItem>
  }
);
