...
figma.connect(
  ...
  'https://www.figma.com/design/aEBBvq0J3EPXxHvv6WgDx9/PatternFly-6--Components-Test?node-id=8949-96121&t=IzSunfrnw18ti37Y-11',
  {
    ...
    example: (props) => (
      // Documentation for FileProgressItemGroup can be found at https://www.patternfly.org/components/file-upload
      <FileProgressItemGroup>{props.children}</FileProgressItemGroup>
    )
  }
);
